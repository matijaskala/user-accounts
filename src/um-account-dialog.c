...
struct _UmAccountDialog {
        ...
        GtkWidget *local_area;
        GtkWidget *enterprise_area;
        GtkWidget *enterprise_offline_area;
...
um_account_dialog_init (UmAccountDialog *self)
{
        ...
        widget = GTK_WIDGET (gtk_builder_get_object (builder, "local-area"));
        self->local_area = widget;

        widget = GTK_WIDGET (gtk_builder_get_object (builder, "enterprise-area"));
        self->enterprise_area = widget;
